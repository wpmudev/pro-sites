...
if ( ! class_exists( 'ProSites_Gateway_2Checkout' ) ) {
	class ProSites_Gateway_2Checkout {
		...
		function __construct() {
			...
			require_once $psts->plugin_dir . "includes/gateways/gateway-2checkout-files/Twocheckout.php";
			//settings
