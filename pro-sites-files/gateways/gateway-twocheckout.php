...
class ProSites_Gateway_Twocheckout {
	...
	function settings() {
		...
		?>
		<div class="postbox">
			<h3 class='hndle'><span><?php _e( '2Checkout', 'psts' ) ?></span> -
				<span class="description"><?php _e( '2Checkout Payment Method', 'psts' ); ?></span></h3>
			...
			<div class="inside">
				...
				<table class="form-table">
					...
					<td>
						<label><input type="checkbox" name="psts[twocheckout_enable]" value="1"<?php echo checked( $psts->get_setting( "twocheckout_enable" ), 1 ); ?> /> <?php _e( 'Enable 2Checkout', 'psts' ) ?>
							<br/>
						</label>
					</td>
					</tr>
