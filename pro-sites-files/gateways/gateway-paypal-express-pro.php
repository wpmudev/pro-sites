...
class ProSites_Gateway_PayPalExpressPro {
	...
	function settings() {
		...
		?>
		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e( 'Paypal Express/Pro', 'psts' ) ?></span> - <span
					class="description"><?php _e( 'Express Checkout is PayPal\'s premier checkout solution, which streamlines the checkout process for buyers and keeps them on your site after making a purchase.', 'psts' ); ?></span>
			</h3>
			...
			<div class="inside">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<span
								class="description"><?php _e( 'You must login to PayPal and create an API signature to get your credentials. <a target="_blank" href="https://www.x.com/developers/paypal/documentation-tools/express-checkout/integration-guide/ECAPICredentials">Instructions »</a>', 'psts' ) ?></span>

							<p><label><?php _e( 'API Username', 'psts' ) ?><br/>
									<input value="<?php esc_attr_e( $psts->get_setting( "pypl_api_user" ) ); ?>"
									       size="30" name="psts[pypl_api_user]" type="text"/>
								</label></p>

							<p><label><?php _e( 'API Password', 'psts' ) ?><br/>
									<input value="<?php esc_attr_e( $psts->get_setting( "pypl_api_pass" ) ); ?>"
									       size="20" name="psts[pypl_api_pass]" type="text"/>
								</label></p>

							<p><label><?php _e( 'Signature', 'psts' ) ?><br/>
									<input value="<?php esc_attr_e( $psts->get_setting( "pypl_api_sig" ) ); ?>"
									       size="70" name="psts[pypl_api_sig]" type="text"/>
								</label></p>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<span
								class="description"><?php _e( 'URL for an image you want to appear at the top left of the payment page. The image has a maximum size of 750 pixels wide by 90 pixels high. PayPal recommends that you provide an image that is stored on a secure (https) server. If you do not specify an image, the business name is displayed.', 'psts' ) ?></span>
					...
					<tr>
						...
						<td>
							<span
								class="description"><?php _e( 'Sets the border color around the header of the payment page. The border is a 2-pixel perimeter around the header space, which is 750 pixels wide by 90 pixels high. By default, the color is black. The value should be a 6 digit hex color.', 'psts' ) ?></span>

							<p>
								<input value="<?php esc_attr_e( $psts->get_setting( "pypl_header_border" ) ); ?>"
								       size="6" maxlength="6" name="psts[pypl_header_border]" type="text"/>
							</p>
						</td>
					</tr>
					<tr>
						...
						<td>
							<span
								class="description"><?php _e( 'Sets the background color for the header of the payment page. By default, the color is white. The value should be a 6 digit hex color.', 'psts' ) ?></span>
					...
					<tr>
						...
						<td>
							<span
								class="description"><?php _e( 'Sets the background color for the payment page. Darker colors may not be allowed by PayPal. By default, the color is white. The value should be a 6 digit hex color.', 'psts' ) ?></span>
					...
					<tr valign="top">
						...
						<td>
							<textarea name="psts[pypl_thankyou]" type="text" rows="4" wrap="soft" id="pypl_thankyou"
							          style="width: 95%"/><?php echo esc_textarea( $psts->get_setting( 'pypl_thankyou' ) ); ?></textarea>
...
Simply go to https://payments.amazon.com/, click Your Account at the top of the page, log in to your Amazon Payments account (if asked), and then click the Your Subscriptions link. This page displays your subscriptions, showing the most recent, active subscription at the top. To view the details of a specific subscription, click Details. Then cancel your subscription by clicking the Cancel Subscription button on the Subscription Details page.", 'psts' );
	...
	function checkout_js() {
		...
		<script type="text/javascript"> jQuery(document).ready(function () {
				jQuery("a#pypl_cancel").click(function () {
