...
class ProSites_Gateway_Stripe2 {
	...
	function __construct() {
		...
		add_action( 'update_site_option_psts_levels', array( 'ProSites_Gateway_Stripe', 'update_psts_levels' ), 10, 2 );
...
// Init actions
ProSites_Gateway_Stripe2::init();

//register the gateway
psts_register_gateway( 'ProSites_Gateway_Stripe2', __( 'Stripe', 'psts' ), __( 'Stripe handles everything, including storing cards, subscriptions, and direct payouts to your bank account.', 'psts' ) );
