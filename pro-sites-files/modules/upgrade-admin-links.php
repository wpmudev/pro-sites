...
//register the module
psts_register_module( 'ProSites_Module_UpgradeAdminLinks', __('Upgrade Admin Menu Links', 'psts'), __('Allows you to add custom menu items in admin panel that will encurage admins to get higher level by redirecting to upgrade page.', 'psts') );
?>