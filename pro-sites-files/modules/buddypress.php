  ...
  static $user_description;
	...
	**/
	...
	function settings() {
		...
		?>
		<div class="postbox">
			<h3 class="hndle" style="cursor:auto;"><span><?php _e('Limit BuddyPress Features', 'psts') ?></span> - <span class="description"><?php _e('Allows you to limit BuddyPress group creation and messaging to users of a Pro Site.', 'psts') ?></span></h3>
			<div class="inside">
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row"><?php _e('Limit Blog tracking', 'psts'); ?></th>
						<td><label><input type="checkbox" name="psts[bp_hide_unpaid]" id="bp_hide_unpaid" <?php checked($psts->get_setting('bp_hide_unpaid')); ?> /> <?php _e('Do not track non-paid sites', 'psts'); ?></label>
						<br /><?php _e('Be aware: Changing this setting will retroactively affect BuddyPress.', 'psts') ?></td>
					</tr>
				</table>
			</div>
		</div>
