...
class ProSites_Module_Ads {
		...
		<div class="inside">
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<select name="psts[ads_level]" class="chosen <?php if ( is_rtl() ) echo "chosen-rtl"; ?>">
							<?php
				...
				<tr valign="top">
					...
					<td>
						<select name="psts[ads_count]" class="chosen <?php if ( is_rtl() ) echo "chosen-rtl"; ?>">
							<?php
							$per_page = $psts->get_setting( 'ads_count', 3 );
	...
	function ads_select( $level, $selected ) {
		?>
		<select name="ads_levels[<?php echo $level; ?>]" id="ads_level_<?php echo $level; ?>" class="chosen <?php if ( is_rtl() ) echo "chosen-rtl"; ?>">
			<?php
